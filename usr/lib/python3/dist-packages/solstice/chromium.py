...
#Dark Mode
def set_profile_darkmode(profilepath, value, chromicolor, chromicolordark, patchvar=False, vartopatch={}):
    #string, bool
    ...
    if value == True:
        ...
        defaultprefs["autogenerated"]["theme"]["color"] = chromicolordark
    else:
        defaultprefs["autogenerated"]["theme"]["color"] = chromicolor
