...
user_pref("browser.download.dir", "DOWNLOADSDIRHERE");
...
user_pref("browser.newtabpage.activity-stream.newtabWallpapers.wallpaper", "");
user_pref("browser.newtabpage.activity-stream.newtabWallpapers.wallpaper-dark", "");
user_pref("browser.newtabpage.activity-stream.newtabWallpapers.wallpaper-light", "");
...
user_pref("floorp.browser.sidebar2.data", "{\"data\":{},\"index\":[]}");
user_pref("floorp.browser.user.interface", 1);
user_pref("floorp.browser.workspaces.enabled", false);
user_pref("floorp.startup.oldVersion", "999999.99.0");
user_pref("floorp.titlebar.favicon.color", false);
